...
//             "https://github.com/christianhelle/sqlcequery/releases/tag/1.3.4"
//         );

//         await page.Locator(
//                 "body:has-text(\"Skip to content Toggle navigation Sign in Product Actions Automate any workflow \")"
//             )
//             .PressAsync("ArrowDown");
//         await page.Locator(
//                 "body:has-text(\"Skip to content Toggle navigation Sign in Product Actions Automate any workflow \")"
//             )
//             .PressAsync("ArrowDown");
...
//                         AriaRole.Link,
//                         new() { NameString = "SQLCEQueryAnalyzer-Binaries-x64.zip" }
//                     )
//                     .ClickAsync();
//             });
//             await page.WaitForURLAsync(
...
//                 await page.GetByRole(
//                         AriaRole.Link,
//                         new() { NameString = "SQLCEQueryAnalyzer-Binaries-x86.zip" }
//                     )
//                     .ClickAsync();
//             });
//             await page.WaitForURLAsync(
...
//                 await page.GetByRole(
//                         AriaRole.Link,
//                         new() { NameString = "SQLCEQueryAnalyzer-Setup-x64.exe" }
//                     )
//                     .ClickAsync();
//             });
//             await page.WaitForURLAsync(
...
//                 await page.GetByRole(
//                         AriaRole.Link,
//                         new() { NameString = "SQLCEQueryAnalyzer-Setup-x86.exe" }
//                     )
//                     .ClickAsync();
//             });
//             await page.WaitForURLAsync(
